...
<html>
    ...
    <body>
        <h1>IMAGE GALLERY</h1>
        <div class="gallery">
            <div class="photo" onclick="openImage('fav.jpg')">
                <img src="dukati.webp" alt="fav">
            </div>
            <div class="photo" onclick="openImage('Race.jpg')">
                <img src="hybusa.avif" alt="Race">
            </div>
            <div class="photo" onclick="openImage('rapunzel.jpg')">
                <img src="nija.avif" alt="Track">
            </div>
            <div class="photo" onclick="openImage('bike.jpg')">
                <img src="r13.jpg" alt="Bike">
            </div>
        </div>

        <footer>
            &copy; 2025 Designed and Developed by Vishvanandh N
        </footer>
